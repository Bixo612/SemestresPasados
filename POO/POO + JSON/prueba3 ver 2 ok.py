...
class Validaciones():
    ...
    def crearRut():
        ...
        while len(rut) == 0 or len(rut) > 10:
            rut = input ("Ingrese el rut del agronauta: ")
...
def menu():
    ...
    while salir:
        ...
        if op == 1:
            ...
            agronauta = Agronauta(VJson)
            agronauta.guardarRegistro()
        if op == 2:
            #Obtener Argonauta
            rt = Validaciones.crearRut()
            agronauta.buscarBdgenerateJson(rt)
menu()         
