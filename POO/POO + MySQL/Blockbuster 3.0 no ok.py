...
class Pelicula():
    ...
    def __init__(self,titulo,año_estreno,duracion,censura,estudio,TipoPelicula):
        self.idPelicula     = Valid.obtenerEspacioId()
        self.titulo         = titulo
...
# print(type(FxSql.listarIds()))

libre = Valid.obtenerEspacioId(FxSql.listarIds())

print(FxSql.listarIds())

print ("El id libre es ",libre)
